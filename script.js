...
document.addEventListener('DOMContentLoaded', () => {
    const cardIds = [
        ...
        'interactive-card9', 'interactive-card10', 'interactive-card11', 'interactive-card12'
    ];
...
document.getElementById('shimmerButton').addEventListener('click', function() {
